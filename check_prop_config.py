    ...
    try:
        ...
        if count == 0:
            ...
            defaults = [
                ...
                ('prop_data_source', 'pskreporter', 'string', 'Propagation data source', 'propagation', 'True', 'True'),
                ('prop_refresh_minutes', '10', 'int', 'Propagation data refresh interval in minutes', 'propagation', 'True', 'True'),
